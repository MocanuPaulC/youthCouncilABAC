...
public class DatabaseSeeder implements CommandLineRunner {
	...
	private void loadData() {
		...
		YouthCouncilSubscription youthCouncilSubscription11 = new YouthCouncilSubscription(userList.get(0), youthCouncil1, SubscriptionRole.COUNCIL_ADMIN);
		YouthCouncilSubscription youthCouncilSubscription12 = new YouthCouncilSubscription(userList.get(0), youthCouncil2, SubscriptionRole.USER);
		...
		YouthCouncilSubscription youthCouncilSubscription51 = new YouthCouncilSubscription(userList.get(4), youthCouncil1, SubscriptionRole.USER);
		YouthCouncilSubscription youthCouncilSubscription52 = new YouthCouncilSubscription(userList.get(4), youthCouncil2, SubscriptionRole.USER);
		...
		youthCouncilSubscriptionRepository.saveAll(List.of(youthCouncilSubscription11, youthCouncilSubscription12, youthCouncilSubscription2, youthCouncilSubscription3, youthCouncilSubscription4, youthCouncilSubscription51, youthCouncilSubscription52, youthCouncilSubscription6, youthCouncilSubscription7));
